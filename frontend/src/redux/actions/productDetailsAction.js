...
export const createProductReview =
  (API, category, id, review) => async (dispatch, getState) => {
    try {
      ...
      await axios.post(`${API}/products/${category}/${id}/reviews`, review, config);
...
// delete product
export const deleteProduct = (API, category, id) => async (dispatch, getState) => {
  try {
...
// update product
export const updateProduct = (API, category, product) => async (dispatch, getState) => {
  try {
