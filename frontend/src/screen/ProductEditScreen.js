...
import { listProductDetails, updateProduct } from '../redux/actions/productDetailsAction';
///     CUSTOM STYLE    ///
...
const ProductEditScreen = ({ history, match, API }) => {
  ...
  }, [dispatch, API, userInfo, productId, productCategory, history, successUpdate]);
          ...
          <Paper elevation={14} className={classes.paperProductEdit}>
            ...
            <Grid container spacing={10} direction="row" justify="space-evenly">
              <Grid item md={6} xs={12}>
                {/* Product Name */}
                <FormControl variant="outlined" className={classes.inputProduct}>
                ...
                {/* Product Brand */}
                <FormControl variant="outlined" className={classes.inputProduct}>
                  <InputLabel htmlFor="outlined-adornment-brand">Brand</InputLabel>
                  <OutlinedInput
                ...
                {/* Product Price */}
                <FormControl variant="outlined" className={classes.inputProduct}>
                  <InputLabel htmlFor="outlined-adornment-brand">Price</InputLabel>
                  <OutlinedInput
              ...
              <Grid item md={6} xs={12}>
                {/* Product image */}
                <FormControl variant="outlined" className={classes.inputProduct}>
                  <InputLabel htmlFor="outlined-adornment-brand">Image</InputLabel>
                  <OutlinedInput
                ...
                {/* Product Description */}
                <FormControl variant="outlined" className={classes.inputProduct}>
                  <InputLabel htmlFor="outlined-adornment-brand">Description</InputLabel>
                  <OutlinedInput
